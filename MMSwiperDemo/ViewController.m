...
@property (weak, nonatomic) IBOutlet MMSwiper *carouselView2;
...
- (void)viewDidLoad {
    ...
    _carouselView2.delegate = self;
    [self.view addSubview:_carouselView2];
    _carouselView2.isInfinite = YES;  //设置是否无限循环
    _carouselView2.isAuto = YES; //设置自动播放
    _carouselView2.models = [self setupDataModels];
}
